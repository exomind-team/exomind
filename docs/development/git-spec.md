...
> **生效日期**: 2026-02-03
> **版本**: v1.1（合并自 pm/git-spec.md + pm/GIT_WORKTREE_SPEC.md）
> **文档位置**: `docs/development/git-spec.md`
> **上次更新**: 2026-03-14
>
> 本文档为 ExoMind 项目 Git 使用规范的**唯一权威来源**，整合了分支管理、worktree 使用、AI 内容管理等内容。以 `main` 分支命名为准（原 GIT_WORKTREE_SPEC.md 中的 `master` 已统一为 `main`）。
