...
export const TASK_DAG_INTERVAL_COLLAPSE_STORAGE_KEY =
...
export const TASK_DAG_LAYOUT_MODE_CHANGED_EVENT =
  "exomind:dag-layout-mode-changed";
export const TASK_DAG_HIDE_TERMINAL_CHANGED_EVENT =
  "exomind:dag-hide-terminal-changed";
export const TASK_DAG_FOCUS_MODE_CHANGED_EVENT =
  "exomind:dag-focus-mode-changed";
export const TASK_DAG_BACKGROUND_CHANGED_EVENT =
  "exomind:dag-background-mode-changed";
export const TASK_DAG_IMMERSIVE_CHANGED_EVENT = "exomind:dag-immersive-changed";
export const TASK_DAG_NODE_SIZING_CHANGED_EVENT =
  "exomind:dag-node-sizing-changed";
export const TASK_DAG_VIEWPORT_CHANGED_EVENT = "exomind:dag-viewport-changed";
export const TASK_DAG_SEARCH_DRAFT_CHANGED_EVENT =
  "exomind:dag-search-draft-changed";
export const TASK_DAG_SEARCH_OPTIONS_CHANGED_EVENT =
  "exomind:dag-search-options-changed";
export const TASK_DAG_TAG_FILTER_CHANGED_EVENT =
  "exomind:dag-tag-filter-changed";
export const TASK_DAG_FOCUSED_SERIES_CHANGED_EVENT =
  "exomind:dag-focused-series-changed";
export const TASK_DAG_INTERVAL_COLLAPSE_CHANGED_EVENT =
  "exomind:dag-interval-collapse-changed";
export const TASK_DAG_VISIBILITY_CHANGED_EVENT =
  "exomind:dag-visibility-changed";
export const TASK_DAG_CONTROLS_STATE_CHANGED_EVENT =
  "exomind:dag-controls-state-changed";
...
function normalizeViewportSurface(
  surface: TaskDagViewportSurface | undefined,
): TaskDagViewportSurface {
...
export function getTaskDagLayoutMode(): TaskDagLayoutMode {
  return readRuntimeBackedValue(TASK_DAG_LAYOUT_MODE_STORAGE_KEY) === "manual"
    ? "manual"
    : "auto";
}

export function setTaskDagLayoutMode(
  mode: TaskDagLayoutMode,
): TaskDagLayoutMode {
...
export function setTaskDagDirection(direction: DagDirection): DagDirection {
  const normalized =
    direction === "TB" || direction === "LR" ? direction : "auto";
  writeRuntimeBackedValue(
...
export function setTaskDagTerminalFilterMode(
  mode: TaskDagTerminalFilterMode,
): TaskDagTerminalFilterMode {
...
export function getTaskDagFocusMode(): TaskDagFocusMode {
  return readRuntimeBackedValue(TASK_DAG_FOCUS_MODE_STORAGE_KEY) === "hard"
    ? "hard"
    : "soft";
}
...
export function setTaskDagBackgroundMode(
  mode: TaskDagBackgroundMode,
): TaskDagBackgroundMode {
...
export function setTaskDagNodeSizing(
  sizing: TaskDagNodeSizing,
): TaskDagNodeSizing {
...
export function setTaskDagSearchOptions(
  options: TaskDagSearchOptions,
): TaskDagSearchOptions {
  const normalized = {
    ...DEFAULT_TASK_DAG_SEARCH_OPTIONS,
    ...options,
  };
...
export function setTaskDagTagFilter(
...
export function setTaskDagFocusedSeriesAnchorIds(
  anchorIds: string[],
): string[] {
...
export function setTaskDagFocusedSeriesAnchorId(
  anchorId: string | null,
): string | null {
  return (
    setTaskDagFocusedSeriesAnchorIds(anchorId ? [anchorId] : [])[0] ?? null
  );
}
...
export function getTaskDagControlsState(): TaskDagControlsState {
  try {
    ...
    return normalizeControlsState(
      JSON.parse(raw) as Partial<TaskDagControlsState>,
    );
  } catch {
    return DEFAULT_TASK_DAG_CONTROLS_STATE;
  }
...
export function setTaskDagControlsState(
