...
| 功能 | 描述 | 来源 |
|------|------|------|
| Ritual Home（仪式首页） | 主程序首页承担“开始今天 / 收住今天”的主流程入口 | issue #591 / 2026-03-19 design |
...
**首页与悬浮窗分工**：
- 主程序首页：负责“定一天”和“收一天”
- Now Workbench Overlay（当下悬浮窗）：负责“过这一天”，承接执行中、短反馈、快速记录、轻提醒
...
| 收工提醒 | 悬浮窗轻提示“可以先收住”，正式收工回主程序完成 | issue #591 / 2026-03-19 design |
