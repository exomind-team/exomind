...
export const ui = {
  zh: {
    ...
    "about.mission.desc":
      "ExoMind（外心）探索一个根本问题：人作为生命如何主动掌控自己的力量？我们构建工具，帮助你记录、反思、成长。",
    "about.philosophy.title": "理念",
    "about.philosophy.desc":
      "生命不是实体或状态，而是时间中持续展开的过程。ExoMind 帮你观察这个过程，理解这个过程，最终掌控这个过程。",
    "about.opensource.title": "开源",
    "about.opensource.desc":
      "ExoMind 是开源项目，代码托管在 GitHub。我们相信透明和社区的力量。",
    "about.brand.eyebrow": "命名与愿景",
    "about.brand.title": "先建立一个人的外心，再连接更多人的外心",
    "about.brand.desc":
      "ExoMind 是单数品牌，指一个人的外心与认知基础设施；exominds 是复数愿景，指多个外心逐步联结成的协作网络。",
