 ...
 * └─────────────────────────────────────────┘
 *
 * 迁移自: src/pages/VoiceChatPage.tsx
 * 迁移时间: 2026-02-10
 */

import { useEffect, useState } from 'react';
import { getVoiceChatService, setASRAdapterType, type ASRAdapterType } from '@exomind/core';
      ...
      <div style={{
        ...
        {adapterType === 'websocket' && (
          <div style={{ marginTop: '8px', padding: '8px', background: '#fef3c7', borderRadius: '6px', fontSize: '11px' }}>
            注意：WebSocket 模式需要浏览器支持自定义认证头部，可能无法正常工作
          </div>
        )}
      </div>
