...
describe('environment bootstrap', () => {
  ...
  it('createRuntimeBootstrap should align web eventlog/task on RT adapters by default', () => {
    ...
    expect(result.eventlog.constructor.name).toBe('EventLogRtAdapter');
  ...
  it('createRuntimeBootstrap should keep web eventlog on RT even when legacy mode is stored', () => {
