...
export const ui = {
  zh: {
    ...
    'features.subtitle': '每一个功能都围绕一个核心：帮助你主动掌控自己的生命过程',
    'features.eventlog.title': '事件日志',
    'features.eventlog.desc': '像写日记一样记录生活，AI 帮你整理和回顾。不可变的事件流，真实记录你的每一天。',
    'features.timeblock.title': '时间块',
    'features.timeblock.desc': '专注计时器 + 能量管理。知道自己的时间花在哪里，找到最佳工作节奏。',
    'features.tasks.title': '任务系统',
    'features.tasks.desc': '不只是待办清单。AI 帮你拆解目标、追踪进度、回顾完成情况。',
    'features.agents.title': 'AI 智能体',
    'features.agents.desc': '个性化的 AI 助手，理解你的习惯和目标，在合适的时机给出建议。',
    'features.privacy.title': '本地优先',
    'features.privacy.desc': '数据存储在你的设备上。你的生命记录，只属于你自己。',
    'features.crossplatform.title': '全平台支持',
    'features.crossplatform.desc': 'Windows、macOS、Linux、Android。随时随地，无缝衔接。',
    ...
    'changelog.subtitle': '每一次更新，都是为了让你的体验更好',
    // Docs
    'docs.title': '文档',
    'docs.subtitle': '了解如何使用 ExoMind 的每一个功能',
    'docs.coming_soon': '文档正在编写中，敬请期待...',
    // About
    'about.title': '关于 ExoMind',
    'about.subtitle': '我们相信，每个人都应该有能力主动掌控自己的生命过程',
    'about.mission.title': '使命',
    'about.mission.desc': 'ExoMind（外心）探索一个根本问题：人作为生命如何主动掌控自己的力量？我们构建工具，帮助你记录、反思、成长。',
    ...
    'footer.copyright': '© 2026 ExoMind. 用心构建。',
  },
  en: {
    // Nav
    ...
    'features.subtitle': 'Every feature revolves around one core idea: helping you actively take control of your life process',
    'features.eventlog.title': 'Event Log',
    'features.eventlog.desc': 'Journal your life like an immutable event stream. AI helps you organize and reflect on every day.',
    'features.timeblock.title': 'Time Blocks',
    'features.timeblock.desc': 'Focus timer + energy management. Know where your time goes and find your optimal rhythm.',
    'features.tasks.title': 'Task System',
    'features.tasks.desc': 'More than a to-do list. AI helps break down goals, track progress, and review completions.',
    'features.agents.title': 'AI Agents',
    'features.agents.desc': 'Personalized AI assistants that understand your habits and goals, offering timely suggestions.',
    'features.privacy.title': 'Local First',
    'features.privacy.desc': 'Your data stays on your device. Your life records belong to you and only you.',
    'features.crossplatform.title': 'Cross Platform',
    'features.crossplatform.desc': 'Windows, macOS, Linux, Android. Seamless experience, anywhere, anytime.',
    'features.cta.title': 'Ready to start?',
    'features.cta.desc': 'Begin now and let AI accompany your growth journey',
    'features.cta.download': 'Download Free',
    // Download
    'download.title': 'Start Your Growth Journey',
    'download.subtitle': 'Free download, runs locally, your data stays yours',
    'download.windows': 'Windows',
    'download.macos': 'macOS',
    'download.linux': 'Linux',
    'download.android': 'Android',
    ...
    'changelog.subtitle': 'Every update is made to improve your experience',
    // Docs
    ...
    'about.subtitle': 'We believe everyone should have the power to actively control their life process',
    'about.mission.title': 'Mission',
    'about.mission.desc': 'ExoMind explores a fundamental question: how can humans actively take control of their own power as living beings? We build tools to help you record, reflect, and grow.',
